...
- [x] 4.2 Create `scripts/approve-builder.ts`. Verify: `pnpm approve` prints a transaction hash and "approved 10 bps for 0x…"; running it a second time does not fail with a stack trace.
