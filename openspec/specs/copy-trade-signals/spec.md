...
- **THEN** the response is 200 with `entryPrice` â‰ˆ 80,000, `tpPrice` â‰ˆ 82,400, `slPrice` â‰ˆ 78,400, `expiresAt` 4 hours after `createdAt`, and `copyCount: 0`
