...
- **P1. A smart 12-year-old can use it.** Every screen has exactly one primary action (one big yellow button). Check: count the yellow buttons on a screen; the answer is 1.
